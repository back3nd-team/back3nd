...
export const AnotherScalarFieldEnumSchema = z.enum(['id','data_field','created_at','updated_at']);
...
export const anotherOrderByRelevanceFieldEnumSchema = z.enum(['id','data_field']);

...
var authConfig = {
    ...
    multiTenancy: {
        enabled: true,
        getTenantId: function (request) {
            var tenantId = request.headers.get('x-tenant-id');
            if (!tenantId)
    ...
    plugins: [
        ...
        (0, plugins_1.organization)({
            allowUserToCreateOrganization: function (user) { return __awaiter(void 0, void 0, void 0, function () {
...
exports.auth = (0, better_auth_1.betterAuth)(authConfig);
